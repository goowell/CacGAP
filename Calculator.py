...
def parse_config():
    ...
    formatted_gap_limits = [(gap_limits[i * 2], gap_limits[i * 2 + 1])
                            for i in range(0, int(len(gap_limits) / 2))]
    formated_offset_limits = [(offset_limits[i * 2], offset_limits[i * 2 + 1])
                              for i in range(0, int(len(offset_limits) / 2))]
...
def caculate_all():
    ...
    gap_ng_index = 'NG_30{0}-GAP'
    offset_ng_index = 'NG_31{0}-OFF'
    gap_skips = [0, 10, 24, 34]
    gap_limits = [(0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.35, 0.24), (0.36, 0.18), (0.36, 0.18), (0.36, 0.18), (0.36, 0.18), (0.36, 0.18), (0.36, 0.18), (0.36, 0.18), (0.36, 0.18), (0.36, 0.18),
    ...
    offset_limits = [(0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23), (0.03, -0.23),
